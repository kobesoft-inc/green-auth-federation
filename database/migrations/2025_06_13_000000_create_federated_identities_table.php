...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('federated_identities', function (Blueprint $table) {
            ...
            $table->morphs('authenticatable', 'federated_identities_index');
            ...
            $table->unique(['authenticatable_type', 'authenticatable_id', 'driver', 'provider_user_id'], 'fed_id_unique');

            // Index for efficient lookups
            $table->index(['driver', 'provider_user_id'], 'fed_id_driver_user_idx');
        });
    }
